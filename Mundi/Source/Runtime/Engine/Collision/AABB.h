...
struct FAABB
{
	...
	static FAABB GetAABB(const TArray<FVector>& Points);

	static FAABB GetAABB(const FVector* Points);

	static FAABB GetShadowAABBInView(TArray<FVector> PointsOnFrustum, TArray<FVector> PointsOnScene, const FMatrix& ViewMatrix);
