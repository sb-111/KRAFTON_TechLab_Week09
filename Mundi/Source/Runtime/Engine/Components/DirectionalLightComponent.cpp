...
BEGIN_PROPERTIES(UDirectionalLightComponent)
	...
	ADD_PROPERTY(bool, bIsPSM, "디렉셔널 라이트", true, "LisPSM을 활성화합니다")
	ADD_PROPERTY(bool, bSceneAABB, "디렉셔널 라이트", true, "Scene의 AABB를 이용해서 섀도우 캐스터를 더 타이트하게 판별합니다")
END_PROPERTIES()
